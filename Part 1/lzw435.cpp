/*
    ...
    Purpose: main file for Algorithms Project 2 (Part 1)
*/
...
int main(int argc, char* argv[]) 
{
   ...
   switch (*argv[1])
   {
      case 'c':
      {
         ...
         writeCompressedFile(compressed, fileName, 12);
